        ...
        output: {
          manualChunks: {
            ...
            radix: [
              ...
              '@radix-ui/react-slot', '@radix-ui/react-switch', '@radix-ui/react-tabs', '@radix-ui/react-toggle', '@radix-ui/react-toggle-group', '@radix-ui/react-tooltip'
            ],
            charts: ['recharts'],
            pdf: ['pdf-lib', 'html2canvas', 'pdfjs-dist'],
            supabase: ['@supabase/supabase-js'],
            ui_misc: ['sonner', 'lucide-react', 'class-variance-authority', 'cmdk', 'embla-carousel-react', 'input-otp', 'next-themes', 'react-resizable-panels']
          }
        }
      }
    },
